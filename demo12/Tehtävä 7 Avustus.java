 ...
 * Ohjelmaan voi kirjoittaa seuraavat komennot:
     ...
     * "?" --> ohjelma antaa apua sen käyttöön
 * muut komennot hylätään
 */
public class Komentorivi extends Help {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (rivi.startsWith("?")) {
                ...
                h.addLine("Helppiä", "Tämä ohjelma tunnistaa seuraavat komennot:");
                h.addLine("Helppiä", "* " +'"'+"Ynnää (numero1) (numero2)"+'"'+ "--> laskee yksinumeroisia kokonaislukuja");
                h.addLine("Helppiä", "* " +'"'+"Isoksi (sana)"+'"'+ "--> muuttaa sanan kirjaimet isoiksi");
                h.addLine("Helppiä", "* " +'"'+"palindromiko (sana)"+'"'+ "--> katsoo, että onko sana palindromi");
                h.addLine("Helppiä", "* " +'"'+"Info"+'"'+ "--> kertoo ohjelman tekijän ja vuoden");
                h.addLine("Helppiä", "* " +'"'+"?"+'"'+ "--> ohjelma antaa apua sen käyttöön");
                h.addLine("Helppiä", "* " +'"'+"loppu"+'"'+ "--> sulkee ohjelman");
                
                h.printTopic("Helppiä");
                //try {
                //    h.readFile("komento.txt");
                //} catch (IOException e) {                    
                //    e.printStackTrace();
                //}
                System.out.println("Anna komento");
            ...
            if (rivi.matches("Info")) {
                System.out.println("Tekijä: Harri Keränen");
                System.out.println("Vuosi: 2020");
                System.out.println("");
                System.out.println("Anna komento");
            }
    ...
    public static boolean Komento(String rivi) {
        ...
        if (rivi.startsWith("?")) return true;
        if (rivi.matches("Info")) return true;
